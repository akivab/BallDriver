...
public class animate : MonoBehaviour
{
	...
	private LocalNetworkScanner myLocalNetworkScanner;
	...
	void selectEffect()
	{
		...
		{
			Debug.Log("Using network effect. Case: " + promoState);
	...
	public void addEffectNameToLoaded(string effectName)
	{
		loaded += "\n" + indent + name;
	...
	void checkLocalNetwork()
	{
		...
		{
			Debug.Log("Network Scanner is NULL");
			return;
		}
	...
	{
		Debug.Log("making a promo effect.");
	...
	int SwapCurrentAnimation(FullBallEffect effect)
	{
		int i;
	...
	void serialKeyDown(char c)
	{
		...
		int i = SwapCurrentAnimation(makeArgEfffect(argv[0], 1, argv));
		keys[i] = c;
	}
